...
public class Lion extends Animal {
    public Lion(float x, float y, float stamina, float fullness, Map map, int id) {
        ...
        this.shape = new Rectangle.Float((float) this.getX() * Tile.getSize(), (float) this.getY() * Tile.getSize(), Tile.getSize() / 2, Tile.getSize() / 2);
    }
